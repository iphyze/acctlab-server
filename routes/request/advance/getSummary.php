...
try {
    ...
    $query = "SELECT 
        ...
        SUM(CASE WHEN payment_status = 'Pending' THEN advance_payment ELSE 0 END) as pending_amount,
        SUM(CASE WHEN payment_status = 'Paid' THEN advance_payment ELSE 0 END) as paid_amount,
        SUM(CASE WHEN payment_status = 'Unconfirmed' THEN advance_payment ELSE 0 END) as unconfirmed_amount,
        ...
        SUM(vat) as total_vat FROM advance_payment_request WHERE YEAR(created_at) = ?";
