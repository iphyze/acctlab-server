...
try {
    ...
    try {
        ...
        $deleteQuery = "DELETE FROM advance_payment_request WHERE id IN ($placeholders)";
        ...
        $logAction = "$loggedInUserEmail deleted request(s) with ID(s): " . implode(', ', $requestIds) . " from Advance Payment Request.";
