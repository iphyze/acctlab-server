...
try {
    ...
    $check = $conn->prepare("SELECT id FROM expense_fund_request_table WHERE id = ?");
    ...
    $dup = $conn->prepare("SELECT id FROM expense_fund_request_table WHERE invoice_number = ? AND suppliers_name = ? AND id != ?");
    ...
    // Update the record
    $update = $conn->prepare("
    UPDATE expense_fund_request_table SET suppliers_name = ?, supplier_id = ?, invoice_number = ?, invoice_date = ?, date_received = ?, project_code = ?, description = ?, 
    ...
    $fetchData = $conn->prepare("SELECT * FROM expense_fund_request_table WHERE id = ?");
