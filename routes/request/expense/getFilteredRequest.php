...
try {
    ...
    // Sorting setup
    $allowedSortFields = ["suppliers_name", "invoice_number", "invoice_date", "payment_status", "amount", "net_value", "created_at"];
    ...
    // Base query
    $baseQuery = "FROM expense_fund_request_table WHERE 1=1";
    $params = [];
    $types = "";
