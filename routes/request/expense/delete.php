...
try {
    ...
    try {
        ...
        $deleteQuery = "DELETE FROM expense_fund_request_table WHERE id IN ($placeholders)";
        ...
        $logAction = "$loggedInUserEmail deleted request(s) with ID(s): " . implode(', ', $requestIds) . " from Expenses Payment Request.";
