...
try {
    ...
    if (!isset($data->email) || !isset($data->password) || !isset($data->accounting_period)) {
        throw new Exception("Email, password and accounting period are required", 400);
    }

    $email = trim($data->email);
    $password = trim($data->password);
    $accounting_period = trim($data->accounting_period);
