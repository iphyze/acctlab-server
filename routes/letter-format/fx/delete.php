...
try {
    ...
    try {
        ...
        $deleteQuery = "DELETE FROM fx_banks_table WHERE id IN ($placeholders)";
        ...
        $logAction = "$loggedInUserEmail deleted bank record(s) with ID(s): " . implode(', ', $bankIds) . " from fx_banks_table.";
